...
*/
    ...
    if(AvlSearch(AVLroot,searchword)==true)
        cout<<"The word : "<<searchword<<" has been successfully Found!"<<endl;
    else
        cout<<"The word : "<<searchword<<" has NOT been Found!"<<endl;
    ...
    AVLdelete(AVLroot,searchword1,0);
    cout<<"The word : "<<searchword1<<" has been DELETED"<<endl;

    preorder(AVLroot);

    std::string searchword2;
    cin>>searchword2;

    if(AvlSearch(AVLroot,searchword2)==true)
        cout<<"The word : "<<searchword2<<" has been successfully Found!"<<endl;
    else
        cout<<"The word : "<<searchword2<<" has NOT been Found!"<<endl;
